...
class StaffsControllerTest < ActionController::TestCase
  ...
  test "should create staff" do
    assert_difference('Staff.count') do
      post :create, staff: { email: @staff.email, name: @staff.name, staff_no: @staff.staff_no }
    end
  ...
  test "should update staff" do
    put :update, id: @staff, staff: { email: @staff.email, name: @staff.name, staff_no: @staff.staff_no }
    assert_redirected_to staff_path(assigns(:staff))
  end
